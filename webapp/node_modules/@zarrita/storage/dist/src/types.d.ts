...
export interface AsyncReadable {
    ...
    getRange?(key: AbsolutePath, range: RangeQuery, opts?: GetOptions): Promise<Uint8Array | undefined>;
}
export interface SyncReadable {
    get(key: AbsolutePath, opts?: GetOptions): Uint8Array | undefined;
    getRange?(key: AbsolutePath, range: RangeQuery, opts?: GetOptions): Uint8Array | undefined;
}
