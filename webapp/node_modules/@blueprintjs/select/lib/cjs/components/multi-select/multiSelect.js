...
var MultiSelect = /** @class */ (function (_super) {
    ...
    function MultiSelect() {
        ...
        _this.renderQueryList = function (listProps) {
            ...
            return (React.createElement(core_1.Popover, tslib_1.__assign({ autoFocus: false, canEscapeKeyClose: true, disabled: disabled, enforceFocus: false, isOpen: _this.state.isOpen, placement: popoverProps.position || popoverProps.placement ? undefined : "bottom-start" }, popoverProps, { className: (0, classnames_1.default)(listProps.className, popoverProps.className), content: React.createElement("div", tslib_1.__assign({ 
                    ...
                    className: _this.props.customTarget != null && !((_a = _this.props.popoverProps) === null || _a === void 0 ? void 0 : _a.matchTargetWidth)
                    ...
                    _this.props.customTarget != null &&
                        _this.getTagInput(listProps, (0, classnames_1.default)(core_1.Classes.FILL, common_1.Classes.MULTISELECT_POPOVER_TAG_INPUT_MARGIN)),
                    listProps.itemList), interactionKind: "click", onInteraction: _this.handlePopoverInteraction, onOpened: _this.handlePopoverOpened, popoverClassName: (0, classnames_1.default)(common_1.Classes.MULTISELECT_POPOVER, popoverProps.popoverClassName), popupKind: core_1.PopupKind.LISTBOX, ref: (0, core_1.mergeRefs)(_this.refHandlers.popover, _this.props.popoverRef), renderTarget: _this.getPopoverTargetRenderer(listProps, _this.state.isOpen) })));
        };
        ...
        _this.getPopoverTargetRenderer = function (listProps, isOpen) {
            ...
            return function (_a) {
                ...
                return React.createElement(targetTagName, tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({ "aria-autocomplete": "list", "aria-controls": _this.listboxId }, popoverTargetProps), targetProps), { "aria-disabled": disabled, "aria-expanded": isOpen, 
                    ...
                    onKeyDown: _this.getTagInputKeyDownHandler(handleKeyDown), onKeyUp: _this.getTagInputKeyUpHandler(handleKeyUp), ref: ref, role: "combobox" }), _this.props.customTarget != null
                    ? _this.props.customTarget(selectedItems, isOpen)
                    : _this.getTagInput(listProps));
            };
        };
        _this.getTagInput = function (listProps, className) {
            ...
            React.createElement(core_1.Button, { "aria-label": "Clear selected items", disabled: disabled, icon: React.createElement(icons_1.Cross, null), onClick: _this.handleClearButtonClick, title: "Clear selected items", variant: "minimal" })) : undefined;
        ...
        _this.handlePopoverOpened = function (node) {
            ...
            if (hasCustomTarget && _this.input != null) {
                var shouldAutofocus = ((_b = (_a = _this.props.tagInputProps) === null || _a === void 0 ? void 0 : _a.inputProps) === null || _b === void 0 ? void 0 : _b.autoFocus) !== false;
                if (shouldAutofocus) {
                    _this.input.focus();
                }
            }
        ...
        _this.getTagInputKeyDownHandler = function (handleQueryListKeyDown) {
            return function (e) {
                ...
                (_c = (_b = _this.props.popoverTargetProps) === null || _b === void 0 ? void 0 : _b.onKeyDown) === null || _c === void 0 ? void 0 : _c.call(_b, e);
            };
        };
    ...
    MultiSelect.prototype.render = function () {
        ...
        var _a = this.props, menuProps = _a.menuProps, openOnKeyDown = _a.openOnKeyDown, popoverProps = _a.popoverProps, tagInputProps = _a.tagInputProps, customTarget = _a.customTarget, restProps = tslib_1.__rest(_a, ["menuProps", "openOnKeyDown", "popoverProps", "tagInputProps", "customTarget"]);
