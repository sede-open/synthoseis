...
var Omnibar = /** @class */ (function (_super) {
    ...
    function Omnibar() {
        ...
        _this.renderQueryList = function (listProps) {
            ...
            return (React.createElement(core_1.Overlay2, tslib_1.__assign({ hasBackdrop: true }, overlayProps, { isOpen: isOpen, className: (0, classnames_1.default)(common_1.Classes.OMNIBAR_OVERLAY, overlayProps.className), onClose: _this.handleOverlayClose }),
                React.createElement("div", tslib_1.__assign({ className: (0, classnames_1.default)(common_1.Classes.OMNIBAR, listProps.className) }, handlers),
                    React.createElement(core_1.InputGroup, tslib_1.__assign({ autoFocus: true, leftIcon: React.createElement(icons_1.Search, null), placeholder: "Search...", size: "large" }, inputProps, { onChange: listProps.handleQueryChange, value: listProps.query })),
                    listProps.itemList)));
        };
    ...
    Omnibar.prototype.render = function () {
        ...
        return (React.createElement(queryList_1.QueryList, tslib_1.__assign({}, restProps, { 
