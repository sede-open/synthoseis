...
var Omnibar = /** @class */ (function (_super) {
    ...
    function Omnibar() {
        ...
        _this.renderQueryList = function (listProps) {
            ...
            return (React.createElement(Overlay2, __assign({ hasBackdrop: true }, overlayProps, { isOpen: isOpen, className: classNames(Classes.OMNIBAR_OVERLAY, overlayProps.className), onClose: _this.handleOverlayClose }),
                React.createElement("div", __assign({ className: classNames(Classes.OMNIBAR, listProps.className) }, handlers),
                    React.createElement(InputGroup, __assign({ autoFocus: true, leftIcon: React.createElement(Search, null), placeholder: "Search...", size: "large" }, inputProps, { onChange: listProps.handleQueryChange, value: listProps.query })),
                    listProps.itemList)));
        };
