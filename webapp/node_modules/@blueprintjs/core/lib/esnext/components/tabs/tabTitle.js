...
export class TabTitle extends AbstractPureComponent {
    ...
    render() {
        ...
        return (React.createElement("div", { ...removeNonHTMLProps(htmlProps), "aria-controls": tabPanelId, "aria-disabled": disabled, "aria-expanded": selected, "aria-selected": selected, className: classNames(Classes.TAB, className), "data-tab-id": id, id: tabTitleId, onClick: disabled ? undefined : this.handleClick, role: "tab", tabIndex: disabled ? undefined : selected ? 0 : -1 },
