...
export class Tabs extends AbstractPureComponent {
    ...
    render() {
        ...
        const tabIndicator = animate ? (React.createElement("div", { className: Classes.TAB_INDICATOR_WRAPPER, style: indicatorWrapperStyle },
    ...
    renderTabPanel = (tab) => {
        ...
        return (React.createElement(TabPanel, { ...tab.props, key: id, className: classNames(className, panelClassName), parentId: this.props.id, selectedTabId: this.state.selectedTabId }));
    };
