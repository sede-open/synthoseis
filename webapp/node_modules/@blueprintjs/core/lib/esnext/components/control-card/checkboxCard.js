...
export const CheckboxCard = React.forwardRef((props, ref) => {
    ...
    return (React.createElement(ControlCard, { ...rest, alignIndicator: alignIndicator, className: classNames(className, Classes.CHECKBOX_CONTROL_CARD), controlKind: "checkbox", ref: ref }));
});
