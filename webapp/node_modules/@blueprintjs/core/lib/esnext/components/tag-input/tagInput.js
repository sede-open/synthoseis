...
export class TagInput extends AbstractPureComponent {
    ...
    maybeRenderTag = (tag, index) => {
        ...
        return (React.createElement(Tag, { active: index === this.state.activeIndex, "data-tag-index": index, key: tag + "__" + index, 
            // eslint-disable-next-line @typescript-eslint/no-deprecated
            large: large, onRemove: this.props.disabled ? undefined : this.handleRemoveTag, size: size, ...props }, tag));
    };
