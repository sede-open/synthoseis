...
export class EditableText extends AbstractPureComponent {
    ...
    renderInput(value) {
        ...
        return multiline ? (React.createElement("textarea", { ref: this.refHandlers.input, ...props, ...customInputAttributes })) : (React.createElement("input", { ref: this.refHandlers.input, type: type, ...props, ...customInputAttributes }));
    }
