...
export class Tree extends React.Component {
    ...
    nodeRefs = {};
    render() {
        return (React.createElement("div", { className: classNames(Classes.TREE, this.props.className, {
