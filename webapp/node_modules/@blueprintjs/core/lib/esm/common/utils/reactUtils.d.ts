 ...
 */
export declare function ensureElement(child: React.ReactNode | undefined, tagName?: keyof React.JSX.IntrinsicElements, props?: React.HTMLProps<HTMLElement>): React.ReactElement<any, string | React.JSXElementConstructor<any>> | undefined;
...
export declare function isReact18OrHigher(): boolean;
