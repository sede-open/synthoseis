...
var PanelView = /** @class */ (function (_super) {
    ...
    PanelView.prototype.maybeRenderBack = function () {
        ...
        return (React.createElement(Button, { "aria-label": "Back", className: Classes.PANEL_STACK_HEADER_BACK, icon: "chevron-left", onClick: this.handleClose, size: "small", text: this.props.previousPanel.title, title: this.props.previousPanel.htmlTitle, variant: "minimal" }));
    };
    return PanelView;
