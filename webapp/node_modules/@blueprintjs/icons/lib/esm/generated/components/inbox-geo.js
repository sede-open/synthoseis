...
export var InboxGeo = React.forwardRef(function (props, ref) {
    var isLarge = props.size >= IconSize.LARGE;
    var pixelGridSize = isLarge ? IconSize.LARGE : IconSize.STANDARD;
    var translation = "".concat(-1 * pixelGridSize / 0.05 / 2);
    var style = { transformOrigin: "center" };
    return (React.createElement(SVGIconContainer, __assign({ iconName: "inbox-geo", ref: ref }, props),
...
InboxGeo.defaultProps = {
    size: IconSize.STANDARD,
};
InboxGeo.displayName = "Blueprint5.Icon.InboxGeo";
export default InboxGeo;
