...
export var Locomotive = React.forwardRef(function (props, ref) {
    var isLarge = props.size >= IconSize.LARGE;
    var pixelGridSize = isLarge ? IconSize.LARGE : IconSize.STANDARD;
    var translation = "".concat(-1 * pixelGridSize / 0.05 / 2);
    var style = { transformOrigin: "center" };
    return (React.createElement(SVGIconContainer, __assign({ iconName: "locomotive", ref: ref }, props),
...
Locomotive.defaultProps = {
    size: IconSize.STANDARD,
};
Locomotive.displayName = "Blueprint5.Icon.Locomotive";
