...
export var PublishFunction = React.forwardRef(function (props, ref) {
    var isLarge = props.size >= IconSize.LARGE;
    var pixelGridSize = isLarge ? IconSize.LARGE : IconSize.STANDARD;
    var translation = "".concat(-1 * pixelGridSize / 0.05 / 2);
    var style = { transformOrigin: "center" };
    return (React.createElement(SVGIconContainer, __assign({ iconName: "publish-function", ref: ref }, props),
...
PublishFunction.defaultProps = {
    size: IconSize.STANDARD,
};
PublishFunction.displayName = "Blueprint5.Icon.PublishFunction";
