...
export var FolderNew = React.forwardRef(function (props, ref) {
    var isLarge = props.size >= IconSize.LARGE;
    var pixelGridSize = isLarge ? IconSize.LARGE : IconSize.STANDARD;
    var translation = "".concat(-1 * pixelGridSize / 0.05 / 2);
    var style = { transformOrigin: "center" };
    return (React.createElement(SVGIconContainer, __assign({ iconName: "folder-new", ref: ref }, props),
...
FolderNew.defaultProps = {
    size: IconSize.STANDARD,
};
FolderNew.displayName = "Blueprint5.Icon.FolderNew";
