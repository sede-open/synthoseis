...
export var FloatingPoint = React.forwardRef(function (props, ref) {
    var isLarge = props.size >= IconSize.LARGE;
    var pixelGridSize = isLarge ? IconSize.LARGE : IconSize.STANDARD;
    var translation = "".concat(-1 * pixelGridSize / 0.05 / 2);
    var style = { transformOrigin: "center" };
    return (React.createElement(SVGIconContainer, __assign({ iconName: "floating-point", ref: ref }, props),
...
FloatingPoint.defaultProps = {
    size: IconSize.STANDARD,
};
FloatingPoint.displayName = "Blueprint5.Icon.FloatingPoint";
