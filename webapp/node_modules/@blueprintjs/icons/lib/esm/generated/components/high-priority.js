...
export var HighPriority = React.forwardRef(function (props, ref) {
    ...
    return (React.createElement(SVGIconContainer, __assign({ iconName: "high-priority", ref: ref }, props),
        React.createElement("path", { d: isLarge ? "M240 80L240 0L160 0L160 80L240 80zM260 400L240 120L160 120L140 400L260 400z" : "M180 40L180 0L140 0L140 40L180 40zM200 320L180 80L140 80L120 320L200 320z", fillRule: "evenodd", transform: "scale(0.05, -0.05) translate(".concat(translation, ", ").concat(translation, ")"), style: style })));
});
