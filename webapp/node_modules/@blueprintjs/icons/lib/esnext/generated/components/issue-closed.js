...
export const IssueClosed = React.forwardRef((props, ref) => {
    ...
    return (React.createElement(SVGIconContainer, { iconName: "issue-closed", ref: ref, ...props },
...
IssueClosed.defaultProps = {
    size: IconSize.STANDARD,
};
IssueClosed.displayName = `Blueprint5.Icon.IssueClosed`;
