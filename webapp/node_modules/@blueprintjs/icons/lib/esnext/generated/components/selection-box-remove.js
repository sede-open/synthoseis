...
export const SelectionBoxRemove = React.forwardRef((props, ref) => {
    ...
    return (React.createElement(SVGIconContainer, { iconName: "selection-box-remove", ref: ref, ...props },
...
SelectionBoxRemove.displayName = `Blueprint5.Icon.SelectionBoxRemove`;
