...
export const SymbolCircle = React.forwardRef((props, ref) => {
    ...
    return (React.createElement(SVGIconContainer, { iconName: "symbol-circle", ref: ref, ...props },
        React.createElement("path", { d: isLarge ? "M80 199.8A120 120 0 0 1 320 199.8A120 120 0 0 1 80 199.8" : "M60 159.8A100 100 0 0 1 260 159.8A100 100 0 0 1 60 159.8", fillRule: "evenodd", transform: `scale(0.05, -0.05) translate(${translation}, ${translation})`, style: style })));
});
