...
export const ArrayNumeric = React.forwardRef((props, ref) => {
    ...
    return (React.createElement(SVGIconContainer, { iconName: "array-numeric", ref: ref, ...props },
...
ArrayNumeric.defaultProps = {
    size: IconSize.STANDARD,
};
ArrayNumeric.displayName = `Blueprint5.Icon.ArrayNumeric`;
