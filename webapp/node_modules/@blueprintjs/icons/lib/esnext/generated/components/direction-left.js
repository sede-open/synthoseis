...
export const DirectionLeft = React.forwardRef((props, ref) => {
    ...
    return (React.createElement(SVGIconContainer, { iconName: "direction-left", ref: ref, ...props },
        React.createElement("path", { d: isLarge ? "M400 339.6L0 199.6L400 59.6L300 199.6z" : "M320 280.2L0 160.2L320 40.2L240 160.2z", fillRule: "evenodd", transform: `scale(0.05, -0.05) translate(${translation}, ${translation})`, style: style })));
});
