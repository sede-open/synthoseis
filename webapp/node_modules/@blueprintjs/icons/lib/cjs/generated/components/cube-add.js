...
exports.CubeAdd = React.forwardRef(function (props, ref) {
    var isLarge = props.size >= iconTypes_1.IconSize.LARGE;
    var pixelGridSize = isLarge ? iconTypes_1.IconSize.LARGE : iconTypes_1.IconSize.STANDARD;
    var translation = "".concat(-1 * pixelGridSize / 0.05 / 2);
    var style = { transformOrigin: "center" };
    return (React.createElement(svgIconContainer_1.SVGIconContainer, tslib_1.__assign({ iconName: "cube-add", ref: ref }, props),
...
exports.CubeAdd.defaultProps = {
    size: iconTypes_1.IconSize.STANDARD,
};
exports.CubeAdd.displayName = "Blueprint5.Icon.CubeAdd";
