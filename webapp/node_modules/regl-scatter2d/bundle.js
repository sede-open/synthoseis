...
function Scatter(regl, options) {
  ...
  let shaderOptions = {
    ...
    attributes: {
      ...
      isActive: (ctx, prop) => prop.activation === true ? {
        constant: [1]
  ...
  // draw sdf-marker
  let markerOptions = Object.assign({}, shaderOptions);
  ...
  // draw circle
  let circleOptions = Object.assign({}, shaderOptions);
...
Scatter.prototype.getMarkerDrawOptions = function (markerId, group, elements) {
  ...
  for (let l = lod.length; l--;) {
    let [from, to] = lod[l];
    batch.push(Object.assign({}, group, {
      markerTexture: this.markerTextures[markerId],
...
Scatter.prototype.update = function () {
  ...
  this.groups = groups = args.map((options, i) => {
    ...
    if (!group) {
      ...
      options = Object.assign({}, Scatter.defaults, options);
    }
    ...
    updateDiff(group, options, [{
      ...
      viewport: vp => {
        let rect = parseRect(vp || [gl.drawingBufferWidth, gl.drawingBufferHeight]);
